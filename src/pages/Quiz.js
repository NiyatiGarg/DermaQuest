...
const skincareQuestions = [
  ...
  },
  {
    ...
    options: [
      { label: "Yes, very easily", value: "My skin is very sensitive to new products" },
      { label: "Sometimes", value: "Sometimes my skin reacts to new products" },
      { label: "No, not really", value: "My skin usually does not react to new products" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      { label: "Less than 1 liter", value: "I drink less than 1 liter of water per day" },
      { label: "1–2 liters", value: "I drink 1–2 liters of water per day" },
      { label: "2–3 liters", value: "I drink 2–3 liters of water per day" },
      { label: "More than 3 liters", value: "I drink more than 3 liters of water per day" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      { label: "Yes", value: "I live in an area with a lot of dust and pollution" },
      { label: "No", value: "I do not live in a polluted area" },
      { label: "Sometimes", value: "Sometimes I am exposed to dust and pollution" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { label: "More glow", value: "I want my skin to look more radiant and glowing" }
    ]
  }
];

function Quiz() {
  const { bgColor, pageTheme, contrastColor, askQuery, aiResponse, setAiResponse } =
...
const [selectedIndex, setSelectedIndex] = useState(null);
  ...
  const evaluateAnswers = async () => {
    try {
      askQuery(answers + 'Please evaluate my skin and tell me my skin type. Also explain the science behind it and suggest me a skin care routine or what kind of products should i use. Answer in short , precise.');
      // setResult(res.data);
    } catch (err) {
